...
const Modal = ({ isOpen, onClose, onSubmit, title, body, footer, actionLabel, disabled }: ModalProps) => {
    ...
    return (
        <>
            <div className="jusify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none bg-neutral-800 bg-opacity-70">
